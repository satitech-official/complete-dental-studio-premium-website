        ...
        <div className="container grid gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          ...
          <div className="grid gap-10">
            ...
            <div className="panel p-6">
              <h2 className="heading-md font-extrabold text-ink">Before-and-after readiness</h2>
              <p className="mt-3 leading-7 text-slate">
                This detail page can show consented clinic cases once authentic media is supplied. Reference visuals should remain clearly labeled until then.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="mt-5 grid gap-4 md:grid-cols-3">
                {related.map((item) => (
                  <Link className="panel p-5 transition hover:-translate-y-1 hover:shadow-glow" href={`/treatments/${item.slug}`} key={item.slug}>
